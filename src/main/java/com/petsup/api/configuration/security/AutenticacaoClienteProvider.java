...
public class AutenticacaoClienteProvider implements AuthenticationProvider {

    private final AuthClienteService usuarioAutorizacaoService;
    private final PasswordEncoder passwordEncoder;

    public AutenticacaoClienteProvider(AuthClienteService usuarioAutorizacaoService, PasswordEncoder passwordEncoder) {
