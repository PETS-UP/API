...
public class AutenticacaoFilterCliente extends OncePerRequestFilter {

    private static final Logger LOGGER = LoggerFactory.getLogger(AutenticacaoFilterCliente.class);

    private final AuthClienteService authClienteService;

    private final GerenciadorTokenJwt jwtTokenManager;

    public AutenticacaoFilterCliente(AuthClienteService authClienteService, GerenciadorTokenJwt jwtTokenManager) {
    ...
    private void addUsernameInContext(HttpServletRequest request, String username, String jwtToken) {
        ...
        UserDetails userDetails = authClienteService.loadUserByUsername(username);
